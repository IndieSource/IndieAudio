...
<div class="content">
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				<h2><i class="fa fa-volume-up"></i>Plays Multiple Audio Formats</h2>
				<p><%= application.name %> can play audio in different formats:</p>
				<ul>
					<li><b>MP3</b> files - for efficient audio storage.</li>
	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				<h2><i class="fa fa-share"></i>Audio Sharing</h2>
				<p>Share your audio in a variety of ways. </p>
				<ul>
